...
public class Project03 {
    public static void main(String [] args) {
        ...
        int num1 = (int) Integer.parseInt(s1);
        int num2 = (int) Integer.parseInt(s2);

        System.out.println("The sum of 24 and 5 = " + (num1 + num2));
        System.out.println("The subtraction of 24 and 5 = " + (num1 - num2));
        System.out.println("The division of 24 and 5 = " + (double) num1 / num2);
        System.out.println("The multiplication of 24 and 5 = " + num1 * num2);
        System.out.println("The remainder of 24 and 5 = " + num1 % num2);

        System.out.println("\n---Task 2 ---\n");

        int myRandomBetween1to35 = (int) (Math.random() * (35 - 1 + 1) + 1);
        System.out.println("Random number = " + myRandomBetween1to35);
        if (myRandomBetween1to35 == 2) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 3) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 5) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 7) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 11) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 13) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 17) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 19) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 23) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 29) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else if (myRandomBetween1to35 == 31) {
            System.out.println("THE NUMBER IS A PRIME NUMBER");
        } else {
        ...
        // if (prime) {
        // num i a prime number
     // else{
    // num is not prime number}

    // if (num ==2 || num==3 || num==5 || num ==7 ){
    // prime // correct way for task 2
    }}
