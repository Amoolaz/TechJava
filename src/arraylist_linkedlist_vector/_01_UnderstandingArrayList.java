...
public class _01_UnderstandingArrayList {
    public static void main(String[] args) {
        ...
        ArrayList <String> names2 = new ArrayList<>(3); // capacity = 10 by default

        // 2. Getting the size of an array vs ArrayList
        ...
        /*
        Add the names below to the ArrayList and print it
        Abdallah
        Vlad
        Saeed
         Suzanne
