...
public class Exercise1_FindMax {
    public static void main(String [] args) {
        ...
        System.out.println("The random number is 1 = " + num1);
        System.out.println("The random number is 2 = " + num2);
        ...
        int max2 = Integer.MIN_VALUE; /// -214743648

        if(num1 > num2 )max2 = max1;
        else max2 = num2;
